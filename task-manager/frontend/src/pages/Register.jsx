...
import { Lock, Mail, User, Eye, EyeOff, ArrowRight, CheckSquare } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-[#080d1a] text-slate-100 overflow-hidden font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-950 flex-col justify-between p-12 overflow-hidden border-r border-slate-800/40">
        ...
        <div className="my-auto relative z-10 max-w-md mx-auto text-center lg:text-left space-y-6">
          ...
          <p className="text-slate-400 leading-relaxed text-sm">
            Join thousands of professionals using TaskFlow Pro to manage tasks, collaborate, and optimize execution flow. Setting up takes less than a minute.
          </p>

          {/* Dummy Mini Task Card Mockups */}
          <div className="space-y-3 pt-6">
            <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-900/60 border border-slate-800/60 backdrop-blur-md">
              ...
              <div className="flex-1 text-left">
                <p className="text-xs font-semibold text-slate-200">Welcome to TaskFlow!</p>
                <p className="text-[10px] text-slate-400">Complete setup to create your first Kanban board.</p>
              </div>
              <span className="text-[10px] font-semibold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded">Setup</span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-md space-y-6 py-8 animate-slide-up relative z-10">
          {/* Form Header */}
          ...
          {/* Form container */}
          <div className="p-8 rounded-2xl bg-slate-950/40 border border-slate-800/50 backdrop-blur-xl shadow-xl space-y-5">
            {error && (
              <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-xs text-red-400 font-medium whitespace-pre-line">
                {error}
              </div>
            )}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900/80 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-slate-200 placeholder:text-slate-600 text-sm font-medium"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-11 py-2.5 rounded-xl bg-slate-900/80 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-slate-200 placeholder:text-slate-600 text-sm font-medium"
                  />
                  <button
                    type="button"
